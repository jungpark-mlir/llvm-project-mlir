// RUN: rocmlir-opt -pass-pipeline="func.func(tosa-to-linalg-named)" -pass-pipeline="func.func(tosa-to-linalg)" -linalg-fuse-elementwise-ops -empty-tensor-to-alloc-tensor -linalg-bufferize -func-bufferize -bufferization-bufferize -buffer-results-to-out-params -finalizing-bufferize -rock-copy-opt  %s |\
