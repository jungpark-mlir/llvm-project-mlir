...
def main() -> None:
    ...
    X0 = onnx.helper.make_tensor_value_info(model_input_name0, onnx.TensorProto.FLOAT, [None, 3072, 1, 256])

    model_output_name = "Y"
    model_output_channels = 3072
    ...
    conv0_in_channels = int(3072/tile_num)
    conv0_out_channels = 3072
    ...
    onnx.save(model_def, "group.onnx")
