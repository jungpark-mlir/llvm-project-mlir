...
def main() -> None:
    ...
    X0 = onnx.helper.make_tensor_value_info(model_input_name0, onnx.TensorProto.FLOAT, [bsize, 128, 56, 56])

    model_output_name = "Y"
    model_output_channels = 128
    Y = onnx.helper.make_tensor_value_info(model_output_name,
                                           onnx.TensorProto.FLOAT,
                                           [bsize, model_output_channels, 28, 28])
    ...
    conv0_in_channels = 128
    conv0_out_channels = 128
    ...
    onnx.save(model_def, "rconv6.onnx")
