...
def main() -> None:
    ...
    sub0_node = onnx.helper.make_node(
        ...
        op_type="Sub",
        inputs=[rmean1_output_node_name, mul1_output_node_name],
    ...
    add1_node = onnx.helper.make_node(
        ...
        op_type="Add",
        inputs=[sub0_output_node_name, const0_tensor_name],
    ...
    mul3_node = onnx.helper.make_node(
        ...
        op_type="Mul",
        inputs=[rmean0_output_node_name, mul2_output_node_name],
    ...
    add2_node = onnx.helper.make_node(
        ...
        op_type="Add",
        inputs=[const2_tensor_name, mul3_output_node_name],
        outputs=[model_output_name]
    )

    # Create the graph (GraphProto)
    graph_def = onnx.helper.make_graph(
        nodes=[add0_node, rmean0_node, mul0_node, rmean1_node, mul1_node, sub0_node, add1_node, sqrt0_node, recip0_node, mul2_node, mul3_node, add2_node],
        name="norm",
    ...
    onnx.save(model_def, "normblock2.onnx")
