...
module attributes {torch.debug_module_name = "ResNet"} {
  func.func @forward(%arg0: tensor<1x64x56x56xf32>) -> tensor<1x64x56x56xf32> {
    ...
    %124 = "tosa.conv2d"(%122, %123, %24) {dilation = dense<[1, 1]>, pad = dense<[1, 1, 1, 1]>, stride = dense<[1, 1]>} : (tensor<1x56x56x64xf32>, tensor<64x3x3x64xf32>, tensor<64xf32>) -> tensor<1x56x56x64xf32>
    ...
    %129 = "tosa.reshape"(%128) {new_shape = dense<[1, 64, 1, 1]>} : (tensor<64x1x1xf32>) -> tensor<1x64x1x1xf32>
    ...
    %136 = "tosa.conv2d"(%134, %135, %24) {dilation = dense<[1, 1]>, pad = dense<[1, 1, 1, 1]>, stride = dense<[1, 1]>} : (tensor<1x56x56x64xf32>, tensor<64x3x3x64xf32>, tensor<64xf32>) -> tensor<1x56x56x64xf32>
